...
$classFile = 'Utilisateur.php'; 


$customProperties = ['Id', 'Nom','Prenom','Email','mdp','id_film'];  
$customGetters = ['getIdFilm', 'getNom','getId','getPrenom','getEmail','getMdp'];
$customSetters = ['setIdFilm', 'setNom','setId','setPrenom','setEmail','setMdp'];  

try {
    $daoClassCode = generateDaoClass($classFile, 'Utilisateur', $customProperties, $customGetters, $customSetters);
